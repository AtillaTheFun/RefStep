...
#        self.m_grid8.__init_mixin__()
    ...
    def ProgressUpdate(self,Label,Status,colour):
        ...
        """
        Update the status tracker in the Run tab. Takes the name of the  heading to update, 
...
class Confirmation (wx.Frame):
    ...
    def __init__(self):
        wx.Frame.__init__(self, None, wx.ID_ANY, 'Sources not calibrated?',size=(800,120))
